...
#
#
def run_rp2(sinkfile_bytes, sourcefile_bytes, rules_bytes, max_steps, topx=100, dmin=0, dmax=1000, mwmax_source=1000, mwmax_cof=1000, timeout=30, logger=None):
    if logger==None:
    ...
    with tempfile.TemporaryDirectory() as tmpOutputFolder:
        ...
        try:
            ...
            try:
                commandObj.wait(timeout=timeout*60.0) #subprocess timeout is in seconds
