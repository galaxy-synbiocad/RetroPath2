...
#
#
def run_rp2(source_path, sink_path, rules_path, max_steps, topx=100, dmin=0, dmax=1000, mwmax_source=1000, mwmax_cof=1000, timeout=30, ram_limit=30, partial_retro=False, logger=None):
    if logger==None:
